...
$pageTitle = 'Admin Dashboard - SITUNEO';
$baseURL = '../';
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge { display: inline-block; padding: 6px 16px; background: #28a745; color: white; border-radius: 20px; font-size: 14px; font-weight: 600; margin-top: 10px; }
...
<body>
    <div class="dashboard-container">
        ...
        <div class="user-info">
            ...
            <p><?php echo htmlspecialchars($_SESSION['full_name'] ?? 'Admin'); ?></p>
            <p>Email: <?php echo htmlspecialchars($_SESSION['email'] ?? ''); ?></p>
            <span class="badge">ADMIN ACCESS</span>
        </div>
        <p class="coming-soon">📊 Full dashboard coming in BATCH 4-6</p>
