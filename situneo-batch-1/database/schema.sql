...
-- ========================================
-- SECTION 9: DYNAMIC SERVICE GENERATOR (4 TABLES)
-- Added: BATCH 1 Extension for Service Generator System
-- ========================================

-- 71. Website Templates for Dynamic Generator
CREATE TABLE `website_templates` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `template_name` varchar(100) NOT NULL,
  `template_slug` varchar(100) NOT NULL,
  `description` text,
  `base_price_setup` decimal(15,2) NOT NULL DEFAULT 350000,
  `base_price_monthly` decimal(15,2) NOT NULL DEFAULT 150000,
...
-- 72. Business Categories for Dynamic Generator (Note: Alternative structure to existing table at line 188)
-- CREATE TABLE `business_categories` (
--   `id` int(11) NOT NULL AUTO_INCREMENT,
...
--   KEY `parent_id` (`parent_id`)
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- NOTE: Table 'business_categories' already exists at line 188. This is commented out to avoid duplicate table name error.

-- 73. Generated Services (Template × Category = 1500+)
-- Note: Alternative structure to existing table at line 246
-- CREATE TABLE `generated_services` (
--   `id` int(11) NOT NULL AUTO_INCREMENT,
--   `template_id` int(11) NOT NULL,
--   `category_id` int(11) NOT NULL,
--   `service_name` varchar(255) NOT NULL,
--   `service_slug` varchar(255) NOT NULL,
--   `what_is_it` text COMMENT 'Apa itu? (bahasa awam)',
--   `for_whom` text COMMENT 'Untuk siapa?',
--   `price_setup` decimal(15,2) NOT NULL,
--   `price_monthly` decimal(15,2) NOT NULL,
--   `features` json DEFAULT NULL,
...
--   FULLTEXT KEY `search` (`service_name`, `what_is_it`, `for_whom`)
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- NOTE: Table 'generated_services' already exists at line 246. This is commented out to avoid duplicate table name error.

-- 74. Service Divisions (10 Divisi Utama)
CREATE TABLE `service_divisions` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `division_slug` (`division_slug`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ========================================
-- END OF SCHEMA
-- Total Tables: 72 (70 original + 2 new)
-- New Tables Added for Dynamic Service Generator:
--   71. website_templates
--   72. service_divisions (business_categories & generated_services commented - already exist)
-- ========================================
-- ========================================
