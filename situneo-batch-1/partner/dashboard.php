...
$pageTitle = 'Partner Dashboard - SITUNEO';
$baseURL = '../';
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge { display: inline-block; padding: 6px 16px; background: #ffc107; color: #212529; border-radius: 20px; font-size: 14px; font-weight: 600; margin-top: 10px; }
...
<body>
    <div class="dashboard-container">
        ...
        <div class="user-info">
            ...
            <p><?php echo htmlspecialchars($_SESSION['full_name'] ?? 'Partner'); ?></p>
            <p>Email: <?php echo htmlspecialchars($_SESSION['email'] ?? ''); ?></p>
            <p>Referral Code: <strong><?php echo htmlspecialchars($_SESSION['referral_code'] ?? 'N/A'); ?></strong></p>
            <span class="badge">PARTNER</span>
        </div>
        <p class="coming-soon">💰 Earnings & commission tracking coming in BATCH 10-12</p>
