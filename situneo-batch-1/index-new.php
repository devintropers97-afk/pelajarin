    ...
    <div class="container">
        <div class="hero-content" data-aos="fade-up">
            ...
            <div class="hero-buttons">
                ...
                <a href="portfolio-new.php" class="btn-secondary">
...
<section class="services">
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px; margin-bottom: 40px;">
            ...
            <div class="service-card" data-aos="fade-up" data-aos-delay="<?php echo ($index + 1) * 100; ?>">
                ...
                <div class="service-card-body">
                    ...
                    <a href="services-new.php" class="btn-primary" style="width: 100%; justify-content: center; font-size: 14px; padding: 12px;">
        ...
        <div style="text-align: center;" data-aos="fade-up">
            <a href="services-new.php" class="btn-primary">
                <i class="fas fa-th"></i>
    ...
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; max-width: 1000px; margin: 0 auto;">
            ...
            <div class="pricing-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <a href="pricing-new.php" class="btn-primary" style="width: 100%; justify-content: center;">
...
<section class="portfolio">
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
            ...
            <div class="portfolio-card" data-aos="fade-up" data-aos-delay="<?php echo ($index + 1) * 50; ?>">
                ...
                <div class="portfolio-overlay">
                    ...
                    <a href="portfolio-new.php" class="portfolio-link">
                        <i class="fas fa-eye"></i>
        ...
        <div style="text-align: center; margin-top: 40px;" data-aos="fade-up">
            <a href="portfolio-new.php" class="btn-primary">
